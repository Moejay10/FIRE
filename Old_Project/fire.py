...
class Persons_Finance:
    ...
    def __init__(self, 
            ...
            invest_info={'Interest': 0.08, 'Years': 15, 'Goal': 1.5E7, 'Invest': 1.5E4},
            ...
            student_loan={'Loan': 7.0E5, 'Start Time': datetime.datetime.strptime('15/01/2027', '%d/%m/%Y').date(), 'Years': 14, 'Interest': 0.04841, 'Serial Loan': False, 'Extra contributions': 0.0E3},
