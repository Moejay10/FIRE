...
class Persons_Finance:
    ...
    def __init__(self, 
            ...
            housing={'Loan': 3.2E6, 'Start Time': datetime.datetime.strptime('15/08/2025', '%d/%m/%Y').date(), 'Years': 30, 'Interest': 0.0525, 'Serial Loan': False, 'Shared Costs': 6.5E3, 'Rent': 11.0E3, 'Extra contributions': 0.0E3},
